...
struct Digits
{
	...
	static void time_with_am_pm(short x, short y, int hours, int minutes)
	{
		short x_cur = x;
		short y_cur = y;
		...
		std::cout << " " << std::setw(2) << std::setfill('0') << hours << ":"
			<< std::setw(2) << std::setfill('0') << minutes << " " << period << std::endl;
	}

	static void display_number(short x, short y, int number)
	{
		short x_cur = x;
		short y_cur = y;
